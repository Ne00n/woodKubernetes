...
class rqlite:
    ...
    def init(self):
        ...
        self.execute(["CREATE TABLE certs (domain TEXT NOT NULL PRIMARY KEY, machine TEXT NOT NULL, api TEXT NOT NULL, fullchain TEXT NULL, privkey TEXT NULL, updated INTEGER NULL, FOREIGN KEY(machine) REFERENCES machines(name) ON DELETE CASCADE)"])
